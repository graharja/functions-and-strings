...
void Find(string str)
{
    ...
    size_t foundPosition = str.find(findme);
...
void GetSubstring(string& str)
{
    ...
    string sub = str.substr(position, length);
...
void AdvancedReplace(string& str)
{
    ...
    size_t foundPosition = str.find(replaceme);

    cout << str.size();
    
    str = str.replace(foundPosition, str.size(), insertString);
