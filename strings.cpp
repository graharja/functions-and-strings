...
int main()
{
    ...
    while (!done)
    {
        ...
        switch (choice)
        {
        case 1:     GetSize(text);            break;
        case 2:     GetLetter(text);          break;
        case 3:     Find(text);               break;
        case 4:     Contains(text);           break;
        case 5:     GetSubstring(text);       break;
        case 6:     GetOrder(text);           break;

        case 7:     Combine(text);            break;
        case 8:     Insert(text);             break;
        case 9:     Remove(text);             break;
        case 10:    Replace(text);            break;
        case 11:    AdvancedReplace(text);    break;
